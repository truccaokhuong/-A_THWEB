    ...
    public partial class AddAuthorizationTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceOwnerships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResourceOwnerships_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceOwnerships_UserId",
                table: "ResourceOwnerships",
                column: "UserId");
